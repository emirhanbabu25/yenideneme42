...
if (!role) return message.channel.send('Rol bulunamadı. `Örnek: s!rol-al @üye @rol`');
  ...
  return message.channel.send(`Alınacak rol sizin rolünüzün üstünde bu yüzden rolü **alamıyorum!**`);
  }
  try{
