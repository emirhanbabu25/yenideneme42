...
.setColor('RED')
.setDescription('Doğru Kullanım : s!istek-bildir <isteğiniz>')
...
.setColor('GREEN')
.setDescription('İstek Kodunuz Başarıyla Bildirildi.\nEn Yakın Zamanda <#781133838428536883> Kanalından Cevap Vereceğiz!')
...
client.channels.cache.get('781133838428536883').send(embed2); 
